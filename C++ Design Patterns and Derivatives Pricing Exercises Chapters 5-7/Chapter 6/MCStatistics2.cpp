...
#include "MCStatistics2.h"
// #include "wrapper.h"
using namespace std;

//Exercice 5.1
StatisticsMoments4::StatisticsMoments4() : RunningSum1(0.0), 
                                           RunningSum2(0.0),
                                           RunningSum3(0.0),
                                           RunningSum4(0.0),
                                           PathsDone(0UL) {}
...
vector<vector<double> > StatisticsMoments4::GetResultsSoFar() const
{
  ...
  Results[0].resize(4);
  Results[0][0] = RunningSum1 / PathsDone;
...
vector<vector<double> >  ValueAtRisk::GetResultsSoFar() const
{
  ...
  int n = tmp.size();
  int var_slot = static_cast<int>(ceil(n*alpha));
