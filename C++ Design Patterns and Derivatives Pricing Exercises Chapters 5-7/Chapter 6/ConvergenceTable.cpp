// C++ Design Patterns and Derivatives Pricing---Listing 5.8, page 96

#include "ConvergenceTable.h"

ConvergenceTable::ConvergenceTable(const Wrapper<StatisticsMC>& Inner_) : Inner(Inner_), StoppingPoint(2), PathsDone(0)
{
	// StoppingPoint = 2;
	// PathsDone = 0;
}
